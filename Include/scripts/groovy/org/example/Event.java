...
public class Event {
    ...
    Event()
    {
        try{
            ...
            BufferedReader in_Admin = new BufferedReader (new FileReader("Include/resources/admin.txt"));
            BufferedReader in_Student = new BufferedReader (new FileReader("Include/resources/student.txt"));
    ...
    {
        try{
            BufferedReader in = new BufferedReader (new FileReader("Include/resources/event.txt"));
            String s;
            System.out.println("\nList of Events: ");
    ...
    {
        try{
            BufferedWriter out_Student = new BufferedWriter (new FileWriter("Include/resources/student.txt"));
    ...
    private static void ValidatePassword(String password) throws PasswordValidationException {
